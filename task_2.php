...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
                                    ...
                                    <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                        <?foreach($arrayList as $item):?>
                                            <li class="list-group-item">
                                                <span data-filter-tags="<?= $item['search']; ?> file"><?= $item['name']; ?></span>
                                            </li>
                                        <?endforeach;?>                                       
                                    </ul>
        ...
        <?/*
            Тут я справился, частично, но потом заметил что фильтр не работает, и начал смотреть решение, потом увидел в решении что есть параметр data-filter-tags
            сразу закрыл решение и решил расширить задачу сам.
        */?>
